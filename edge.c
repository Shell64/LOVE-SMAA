...
varying vec4 offset[3];
	...
	vec4 position(mat4 transform_projection, vec4 vertex_position)
	{
		...
		SMAAEdgeDetectionVS(VertexTexCoord2.xy, offset);
...
{
	return vec4(SMAAColorEdgeDetectionPS(texture_coords, offset, texture).xy, 0.0, 1.0);
	//return vec4(SMAALumaEdgeDetectionPS(texture_coords, offset, texture).xy, 0.0, 1.0);
}
#endif